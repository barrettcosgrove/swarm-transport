...
Renders the final policy of each full_400_multiseed run as its own GIF.
...
SEEDS = (0, 1, 2)
CHECKPOINT_DIR = "train/checkpoints/full_400_multiseed"


def main():
    for seed in SEEDS:
        path = f"{CHECKPOINT_DIR}/seed_{seed}/checkpoint_400.pt"
        out = f"outputs/actor_full_400_multiseed_seed_{seed}.gif"
